...
# default is used.
# Type: Directory
c.downloads.location.directory = '~/Baixades'
...
# Type: QssColor
c.colors.hints.fg = COL_BG_1 #'#282c34'

# Font color for the matched part of hints.
# Type: QtColor
c.colors.hints.match.fg = COL_VERD #'#98be65'

# Background color of an info message.
# Type: QssColor
c.colors.messages.info.bg = COL_BG_1 #'#282c34'

# Background color of the statusbar.
# Type: QssColor
c.colors.statusbar.normal.bg = COL_BG_1 #'#282c34'

# Foreground color of the statusbar in insert mode.
# Type: QssColor
c.colors.statusbar.insert.fg = COL_BLANC #'white'
...
# Type: QssColor
c.colors.statusbar.command.bg = COL_BG_1 #'#282c34'
...
# Type: QssColor
c.colors.tabs.bar.bg = COL_BG_1 #'#1c1f34'

# Background color of unselected odd tabs.
# Type: QtColor
c.colors.tabs.odd.bg = COL_BG_1 #'#282c34'

# Background color of unselected even tabs.
# Type: QtColor
c.colors.tabs.even.bg = COL_BG_1 #'#282c34'
...
config.bind(',ad', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/css/ad.css ""')
